      ...
      <div className="w-full max-w-md sm:max-w-lg">
        ...
        <Card className="w-full shadow-[0_4px_24px_rgba(182,111,235,0.15)]">
          <CardHeader className="space-y-1 px-6 pt-6">
            ...
            <CardTitle className="text-2xl text-center">Sign Up with Email</CardTitle>
            <CardDescription className="text-center">Create your account with email and password</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 px-6 pt-4">
            ...
            <Button className="w-full h-14 mt-4 text-base">Create Account</Button>
          </CardContent>
