     ...
     <header className="fixed top-0 w-full bg-white   z-50">
      ...
      <div className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-[#c750f7]">Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
        </div>
      </div>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-3xl font-bold text-black m-0">Information We Collect</h2>
            </div>
            
            <h3 className="text-2xl font-semibold text-black mt-8 mb-4">Personal Information</h3>
            ...
            <h3 className="text-2xl font-semibold text-black mt-8 mb-4">Cryptocurrency Data</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-semibold text-black mt-8 mb-4">Automatically Collected Information</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-3xl font-bold text-black m-0">How We Use Your Information</h2>
            </div>
          ...
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-3xl font-bold text-black m-0">Data Security</h2>
            </div>
          ...
          {/* Information Sharing */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-black mb-6">Information Sharing and Disclosure</h2>
          ...
          {/* Cookies */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-black mb-6">Cookies and Tracking Technologies</h2>
          ...
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-3xl font-bold text-black m-0">Contact Us</h2>
            </div>
      ...
      {/* Footer <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <p className="text-gray-700 mb-2"><strong>Email:</strong> privacy@cryptosnoop.com</p>
              <p className="text-gray-700 mb-2"><strong>Support:</strong> support@cryptosnoop.com</p>
              <p className="text-gray-700"><strong>Address:</strong> CryptoSnoop Privacy Team, [Your Address]</p>
            </div> */}
