        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-4 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="px-6 py-2 rounded-lg bg-[#c750f7] text-white font-semibold hover:bg-[#d575fc] transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Get Started
            </button>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="bg-[#c750f7] hover:bg-[#d575fc] text-white rounded-xl p-3 transition-all duration-300 shadow-lg hover:shadow-xl" onClick={() => setIsAuthModalOpen(true)}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center gap-6 mb-6">
            <p
              ...
              className="text-gray-600 cursor-pointer hover:text-[#c750f7] transition-colors duration-300 font-medium underline"
            >
              contact us
            </p>
            <a
