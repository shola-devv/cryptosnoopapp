...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-[#0b0b0b]">
      {/* Header */}
      <header className="fixed top-0 w-full bg-white dark:bg-[#0b0b0b] z-50 border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col leading-none">
              <span
                className="font-bold text-sm sm:text-lg md:text-xl leading-tight text-[#c750f7]"
              >
                crypto
              </span>
          ...
          <a
            href="/home"
            className="px-6 py-2 rounded-lg underline text-sm sm:text-base md:text-lg text-black dark:text-white hover:text-[#d575fc] dark:hover:text-[#d575fc]"
          >
            Back
          </a>
        </div>
      ...
      {/* Hero Section */}
      <div className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white dark:from-[#101010] dark:to-[#0b0b0b]">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-bold text-3xl sm:text-5xl md:text-6xl text-black dark:text-white mb-4">
            Privacy Policy
          </h1>
