    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-purple-50 to-purple-100 dark:from-slate-900 dark:to-slate-800">
       ...
       <header className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-10">
        ...
        {/* Footer */}
        <footer className="bg-white dark:bg-slate-800 text-gray-900 dark:text-white py-12 border-t border-slate-200 dark:border-slate-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="flex items-center justify-center gap-6 mb-6 flex-wrap">
              <a
                href="/home/privacy"
                className="text-gray-600 dark:text-gray-400 hover:text-[#c750f7] underline transition-colors"
              >
                Privacy Policy
              </a>
              <a
