  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-purple-50 to-purple-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <div className="container mx-auto px-3 sm:px-6 py-4 sm:py-8">
        {/* Back Button */}
        <a href="/home">
          <button className="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-[#c750f7] dark:hover:text-[#c750f7] transition-colors mb-6 cursor-pointer">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              >
                ...
                <svg className={`w-5 h-5 transition-transform ${showChainDropdown ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {monitoredWallet && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            <Card className="border-0 shadow-lg md:col-span-2" style={{ boxShadow: '0 8px 30px -3px rgba(199, 80, 247, 0.3)' }}>
              <CardContent className="p-6">
                <div className="flex items-center justify-between gap-6">
                  ...
                  <div className="flex flex-col items-end gap-3">
                    <div>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mb-1 text-right">Total Balance</p>
                ...
                <div className="mt-4 flex items-center gap-2 pt-4 border-t border-slate-200 dark:border-slate-700">
                  ...
                  <span className={`text-sm font-bold ${monitoredWallet.change24h >= 0 ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="border-0 shadow-lg" style={{ boxShadow: '0 8px 30px -3px rgba(199, 80, 247, 0.3)' }}>
                <CardContent className="p-6">
                  <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">Change in 24H</p>
              ...
              <Card className="border-0 shadow-lg" style={{ boxShadow: '0 8px 30px -3px rgba(199, 80, 247, 0.3)' }}>
                <CardContent className="p-6">
                  <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">Total Assets</p>
        ...
        {monitoredWallet && topAssets.length === 0 && (
          <div className="text-center py-12">
            <p className="text-slate-600 dark:text-slate-400">No assets found for this wallet on {selectedChainData?.name}</p>
          </div>
        )}
      </div>
      ...
      <footer className="mt-12 bg-white text-gray-900 py-12 relative z-10 dark:bg-slate-900/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center gap-6 mb-6">
            <a href="/home/privacy" className="text-gray-600 hover:text-[#c750f7] transition-colors duration-300 font-medium underline dark:text-white cursor-pointer">privacy policy</a>
            <a href="/home/help" className="text-gray-600 hover:text-[#c750f7] transition-colors duration-300 font-medium underline dark:text-white cursor-pointer">Help</a>
            <a href={`https://twitter.com/intent/follow?screen_name=cryptosnoop_app`} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[#c750f7] transition-colors duration-300 font-medium underline dark:text-white cursor-pointer">our socials</a>
